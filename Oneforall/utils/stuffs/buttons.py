...
class BUTTONS(object):
    MBUTTON = [
        [
            InlineKeyboardButton("✏️ᴇᴅɪᴛ-ᴍsɢ", callback_data="mplus HELP_ChatGPT"),
        ...
        [
            InlineKeyboardButton("❤️ᴄᴏᴜᴘʟᴇꜱ", callback_data="mplus HELP_Couples"),
        ...
        [
            InlineKeyboardButton("🗣️ᴛᴛs", callback_data="mplus HELP_TTS"),
        ...
        [
            ...
            InlineKeyboardButton("ᯤ ʜᴏᴍᴇ ᯤ", callback_data=f"settings_back_helper"),
